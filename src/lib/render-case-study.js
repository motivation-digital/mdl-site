...
const PROJECTS = {
  ...
  'health-platform-dreambody-01': {
    ...
    title: 'Personalised Health Coaching at Scale',
    sub: 'A health and wellness platform designed to empower women with tailored insights, personalised programs, and lifestyle adaptations &#8212; without the guilt or guesswork.',
    metric: '4 Health Dimensions',
    metricNote: '(Movement, Nutrition, Mind and Lifestyle &#8212; personalised into a complete wellness journey)',
    heroShot: 'https://imagedelivery.net/8taA81TQ4UD-fca9BHMP5A/33f2497e-888b-43aa-e9a5-8fd0bb911d00/public',
    heroShotAlt: 'DreamBodyClub &#8212; Health assessment and personalised program dashboard',
    siteAddr: 'dreambody.club',
    productHero: true,
    dbc: true,
    recogCount: 589,
    recogCountSuffix: '+',
    recogCountLabel: 'expert-designed workouts and recipes, fully personalised',
    pullGlow: 'The goal was never another fitness app. It was <span style="color:var(--amber)">a personalised health system</span> that meets every woman where she is &#8212; and moves at her pace.',
    transformLabel: 'The Build',
    transformTitle: 'From Generic Programs to Personalised Health Journeys',
    challengeNote: 'Women know they should look after their health &#8212; but most feel stuck between contradictory advice, unrealistic timescales, and programs built for someone else.',
    solutionNote: 'We built a platform that starts with assessment, not assumption &#8212; then personalises every workout, recipe, and lifestyle recommendation to fit real life.',
    challenge: [
      'No clear path forward &#8212; conflicting nutrition and fitness advice everywhere',
      'Time-poor: work, family, and home already fill the day',
      'Programmes designed for &#8220;perfect&#8221; lives &#8212; not real ones',
      'Generic content library doesn&#8217;t adapt to individual goals or constraints',
      'High drop-off rates when initial motivation fades',
    ],
    solution: [
      'A personalised health assessment that scores Movement, Nutrition, Mind and Lifestyle',
      'AI-powered program engine that adapts recommendations to available time',
      'Curated 589-workout library with true 5-minute sessions &#8212; no gym, no equipment',
      'Recipe library (316+) filtered by time, dietary preference and nutritional goals',
      'Member dashboard that tracks progress and adjusts as life changes',
    ],
    pull: 'The goal was never another fitness app. It was a personalised health system built around how women actually live.',
    techLogos: [
      { src: 'https://imagedelivery.net/8taA81TQ4UD-fca9BHMP5A/1ce95ac2-a78a-41f1-83d4-768846b3f300/public', alt: 'DreamBodyClub' },
      { src: 'https://www.cloudflare.com/img/logo-cloudflare-dark.svg', alt: 'Cloudflare' },
      { src: 'https://imagedelivery.net/8taA81TQ4UD-fca9BHMP5A/ms-tech-claude/public', alt: 'Claude AI' },
    ...
    capsTitle: 'A Health Platform Built for Real Life',
    capsSub: 'Assessment, personalisation, and adaptation &#8212; not judgement.',
    capabilities: [
      { h: 'Health Assessment', img: 'https://imagedelivery.net/8taA81TQ4UD-fca9BHMP5A/33f2497e-888b-43aa-e9a5-8fd0bb911d00/public', desc: 'We built a diagnostic engine that measures four dimensions of health, then uses those insights to drive personalisation across the entire platform.', bullets: ['Movement, Nutrition, Mind and Lifestyle scoring', 'Outcome-focused recommendations, not generic advice', 'Baseline tracking to measure real progress'] },
      { h: 'Personalised Programs', img: 'https://imagedelivery.net/8taA81TQ4UD-fca9BHMP5A/33f2497e-888b-43aa-e9a5-8fd0bb911d00/public', desc: 'Programs that adapt to how much time members actually have, not how much they wish they had.', bullets: ['AI-powered recommendations based on assessment data', 'Time-adapted workout and nutrition plans', 'Progress tracking with real-time adjustments'] },
      { h: 'Workout Library', img: 'https://imagedelivery.net/8taA81TQ4UD-fca9BHMP5A/33f2497e-888b-43aa-e9a5-8fd0bb911d00/public', desc: 'A curated library of 589+ workouts designed for real life &#8212; from 5-minute sessions to full routines, no gym or equipment required.', bullets: ['True 5-minute to 45-minute workout options', 'No equipment required &#8212; home-friendly focus', 'Categorised by intensity, type and available time'] },
    ],
    websiteLabel: 'Platform Architecture',
    websiteTitle: 'A Health Platform Built at the Edge',
    websiteBody: [
      'DreamBodyClub runs on Cloudflare&#8217;s global edge network &#8212; ensuring fast, reliable access to assessments, personalised programs and content libraries from anywhere in the world.',
      'The assessment engine feeds the personalisation algorithm; workouts and recipes are filtered in real time based on member goals, time, dietary preferences and progress. Every interaction teaches the system more about the member, refining recommendations continuously.',
    ],
    funnelLabel: 'Key platform capabilities we engineered:',
    funnel: [
      'AI-powered health assessment and scoring',
      'Personalised program generation engine',
      '589+ workout library with real-time filtering',
      '316+ recipe library with nutritional data',
      'Member dashboard with progress tracking',
      'Continuous learning and recommendation refinement',
    ],
    resultsLabel: 'The Platform',
    resultsTitle: 'Health That Adapts to Her Life',
    results: [
      { n: '4', count: 4, prefix: '', suffix: '', l: 'Health Dimensions Assessed', sub: 'Movement, Nutrition, Mind and Lifestyle' },
      { n: '589', count: 589, prefix: '', suffix: '+', l: 'Workout Options', sub: 'From 5 minutes to full routines, no equipment needed' },
      { n: '316', count: 316, prefix: '', suffix: '+', l: 'Recipe Library', sub: 'Filtered by time, diet, and nutritional goals' },
      { n: '100%', count: 100, prefix: '', suffix: '%', l: 'Personalised', sub: 'Every recommendation adapts to her situation' },
    ],
    calloutPre: 'Health that starts with assessment, not assumption.',
    callout: 'Built for women who want real wellness',
    calloutSub: 'Personalised programs, not generic advice. Tailored to how you actually live.',
    testimonials: [
      { name: 'Krista Kolodziejzyk', role: 'CEO &#126; Dietitian Success Center', img: 'https://imagedelivery.net/8taA81TQ4UD-fca9BHMP5A/ms-testi-krista/public', date: 'June 05, 2025', quote: 'OH MY GOODNESS!!! It&#8217;s a million times better!!! The new site looks amazing so far! Things have been going really well and we&#8217;re still absolutely loving the site. Not having to worry about tech has freed us up so much to actually figure out our funnel.', html: 'OH MY GOODNESS!!! <span class="t-am">It&#8217;s a million times better!!!</span> The new site looks amazing so far! Things have been going really well and we&#8217;re still absolutely loving the site. <strong>Not having to worry about tech</strong> has freed us up so much to actually figure out our funnel.' },
      { name: 'Caitlin Mitchel', role: 'CEO &#126; EBAcademics.com', img: 'https://imagedelivery.net/8taA81TQ4UD-fca9BHMP5A/ms-testi-caitlin/public', date: '', quote: 'You guys absolutely freaking nailed it for us. You guys are the best, and I want to keep working with you forever. Thank you!', html: 'You guys absolutely <span class="t-am">freaking nailed it for us.</span> You guys are the best, and <strong>I want to keep working with you forever.</strong> Thank you!' },
      { name: 'Lisa Vanderkwaak', role: 'founder &#126; SpeakToTransform.com', img: 'https://imagedelivery.net/8taA81TQ4UD-fca9BHMP5A/ms-testi-lisa/public', date: '', quote: 'The results I got from Motivation proved that nothing is impossible when you are partnered with the right company.', html: 'The results I got from Motivation proved that <strong>nothing is impossible</strong> when you are <span class="t-am">partnered with the right company.</span>' },
    ...
    ctaTitle: 'Build a Health Platform Like DreamBodyClub',
    ctaBtn: 'Start Your Project',
    ctaSub1: 'We design and build personalised health, fitness, and wellness platforms &#8212; from assessment engines to content libraries.',
    ctaSub2: 'From diagnosis to daily habit &#8212; engineered to fit real lives.',
    logos: [
      { src: 'https://imagedelivery.net/8taA81TQ4UD-fca9BHMP5A/ms-client-trr/public', alt: 'Time Rich Recruiter' },
      { src: 'https://imagedelivery.net/8taA81TQ4UD-fca9BHMP5A/ms-client-gkr/public', alt: 'GKR Karate' },
      { src: 'https://imagedelivery.net/8taA81TQ4UD-fca9BHMP5A/ms-client-lifemap/public', alt: 'LifeMap' },
